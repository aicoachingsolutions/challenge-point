...
// Lives outside this module so it can be imported — and therefore unit-tested — without an OpenAI
// key. Re-exported because callers (and the local generation harness) import it from here.
import { mapStructuredActivityToLegacy } from '../system/activity/map-structured-activity-to-legacy'
export { mapStructuredActivityToLegacy }
import {

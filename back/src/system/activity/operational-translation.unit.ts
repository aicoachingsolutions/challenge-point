...
const mechanics = buildActivityMechanicsFromSkeleton({ activities: [liveRuleSlot], sessionEmphasis: undefined, learningStageDirective: [], practiceSituationDirective: [] })
assert.equal(

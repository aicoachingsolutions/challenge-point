...
const mechanics = buildActivityMechanicsFromSkeleton({ activities: [liveRuleSlot], sessionEmphasis: undefined, learningStageDirective: [], practiceSituationDirective: [], experienceDesignDirective: [] })
assert.equal(

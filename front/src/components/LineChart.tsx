    ...
    return (
        <div ref={ref} className={cx('h-80 w-full', className)} tremor-id='tremor-raw' {...other}>
            <ResponsiveContainer>
                ...
                >
                    {showGridLines ? (
                        <CartesianGrid className={cx('stroke-gray-200 stroke-1 ')} horizontal={true} vertical={false} />
                    ) : null}
                    <XAxis
                    ...
                    >
                        {xAxisLabel && (
                            <Label position='insideBottom' offset={-20} className='text-sm font-medium fill-gray-800 '>
                                {xAxisLabel}
                            </Label>
                        )}
                    </XAxis>

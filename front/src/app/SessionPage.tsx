 ...
 * Solutions Under Pressure", the NARROW variation profile, while the engine's own default for an
 * unchosen emphasis is the differentiated Discovering profile. Removing the control was meant to let
 * every new session use that default.
 *
 * It did not, until 14 Sep: the back-end session schema kept its own 'applying' default and wrote it
 * onto every session, so coaches still got the narrow profile. The schema default is gone now; see
 * resolveSessionEmphasis in the back end.
 */
